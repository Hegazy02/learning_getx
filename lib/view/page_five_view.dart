...
class PageFive extends StatelessWidget {
  ...
  //يعني لو هي في محطوطة في الهوم سكرين مثلا ودخلت على صفحة تانية فيها فايند ورجعت للهوم تاني هو هنا عارف اني استخدمت الازي مره قبل كدا فمش هيستخدمها تاني عشات الهوم موجوده معايا في الستاك وهيصحل ايريرو لما افتح صفحة الفايند تاني
  ...
  //لو استخدمت اللازي بوت في الهوم سكرين
  @override
